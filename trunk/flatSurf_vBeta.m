% surface deets
patientID = 'u0280902';
surfPath = sprintf('/usr/local/freesurfer/subjects/%s/surf/',patientID);

%% loading centroids
trodesPath = '/home/user1/Desktop/R5/Tyler/CorticalStim/CS201810/Imaging/Registered/';
trodesName = 'electrodes.mat';
